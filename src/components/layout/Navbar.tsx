      ...
      <div className="container-custom">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2 flex-col w-full sm:w-auto sm:flex-row">
            <svg width="610" height="311" className="h-12 w-16" viewBox="0 0 610 311" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<span className="text-xs md:text-2xs">Gegründet um zu bleiben</span>
	    </div>
          </Link>
